    ...
    public boolean onCommand(CommandSender aCommandSender, Command aCommand, String aString, String[] aStrings) {
        if (aCommandSender instanceof Player) {
            ...
            if (aStrings.length > 1) {
                lPos1 = Framework.plugin.getPositionMarker(aStrings[0]);
                lPos2 = Framework.plugin.getPositionMarker(aStrings[1]);
                ...
                lPos1 = Framework.plugin.getPositionMarker("1");
                lPos2 = Framework.plugin.getPositionMarker("2");
            }
